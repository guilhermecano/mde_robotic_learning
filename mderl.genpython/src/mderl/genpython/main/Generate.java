...
import mderl.impl.MderlPackageImpl;
...
public class Generate extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/mderl/genpython/main/generate";
    ...
    public static void main(String[] args) {
    	EPackage rlPackage = MderlPackageImpl.eINSTANCE;
    	EPackage.Registry.INSTANCE.put(rlPackage.getNsURI(), rlPackage);
        try {
            if (args.length < 2) {
